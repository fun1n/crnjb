...
$sql1 = "SELECT * FROM tblftpfilenames WHERE FileState=0 AND tblAreaID=0005";
...
$filename = 'ftp://solarad:4r4w2015@ftp.meteopilipinas.gov.ph'.$row["tblftpfile"];
    ...
    foreach(array_values($parts) as $key => $value)
		{
			...
			//	echo $findata."splitted value ".$cnt2."<br/>";
							...
							else if($cnt2==9){ //pagnapuntahan ulit ang bohol lagyan ng voltage
		...
		$sql = "INSERT INTO tblftpfiledata (RecNum, tblAreaID, slrDate, slrTime, AvgUv, MinUv, MaxUv, AvgTmpUv, MinTmpUv, MaxTmpUv, BattVolt, AvgSolRad, MinSolRad, MaxSolRad, AvgSunshine) 
													 	VALUES ('', '0005','".$slrDate."','".$slrTime."','".$slrAvgUv."','".$slrMinUv."','".$slrMaxUv."','".$slrAvgUvTmp."','".$slrMinUvTmp."','".$slrMaxUvTmp."','12.0','".$slrAvgRad."','".$slrMinRad."','".$slrMaxRad."','".$slrAvgSunshine."')";
...
$sqla = "UPDATE tblftpfilenames SET FileState='1' WHERE tblftpfile='".$row["tblftpfile"]."'";
	 ...
	 echo "Tuge: All records are updated.";
